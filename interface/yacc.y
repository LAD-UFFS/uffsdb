...
start: insert | select | delete | create_table | create_database | drop_table | drop_database
     ...
     | qualquer_coisa | implement | update | /*epsilon*/;
...
opt_semicolon: /* epsilon */ | semicolon;
...
set_clause: OBJECT { setUpdateColumn(yytext); }
            RELACIONAL /* Presume que RELACIONAL inclui = */
            value_set;

value_set: VALUE { setUpdateValue(yylval.strval, 'D'); } /* 'D' para Double/Value */
         | NUMBER { setUpdateValue(yylval.strval, 'I'); } /* 'I' para Integer */
         | STRING { setUpdateValue(yylval.strval, 'S'); }; /* 'S' para String */
