...
/**
 * @brief Abre um arquivo no modo de leitura e escrita binária.
...
/**
 * @brief Lê uma página específica do disco para o campo data de um tp_buffer.
 *        Se o arquivo for menor que o offset esperado (página nova/vazia), preenche
...
/**
 * @brief Escreve o campo data de um tp_buffer em uma página específica do disco.
 *        Se o arquivo for menor que o offset necessário, preenche o espaço
...
/**
 * @brief Conveniência: abre o arquivo por nome, lê a página e fecha o arquivo.
 */
...
/**
 * @brief Conveniência: abre o arquivo por nome, escreve a página e fecha o arquivo.
 */
